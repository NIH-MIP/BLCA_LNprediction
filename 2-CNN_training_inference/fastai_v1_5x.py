...
class VisionBinary:
    ...
    def __init__(self):
        self.imagedir='/data/decon/5x'
        self.outdir='/data/decon/5x/training_log'
        self.testPath=os.path.join(self.imagedir,'test')
        self.model_name='5x_rn101'
        self.tr_name='train'
        self.val_name='val'
    ...
    def load_jpg_from_folder(self):
        ...
        #extralist = [crop_pad(size=448, row_pct=0.5, col_pct=0.5), ]
        tfms = get_transforms(flip_vert=True,max_rotate=45,max_zoom=1.2,max_warp=0.1,max_lighting = 0.05,p_lighting=0.5,p_affine=0.5)#, xtra_tfms=extralist)
