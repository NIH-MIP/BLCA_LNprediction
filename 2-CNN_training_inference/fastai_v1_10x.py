...
class VisionBinary:
    ...
    def __init__(self):
        self.imagedir='/data/decon/10x'
        self.outdir='data/decon/10x/training_log'
        self.testPath=os.path.join(self.imagedir,'test')
        self.model_name='10x_rn101'
        self.tr_name='train'
        self.val_name='val'
        ...
        self.bs=45
        self.device=2
        self.dc_e=50 #last layers epochs
    ...
    def load_jpg_from_folder(self):
        ...
        tfms = get_transforms(flip_vert=True,max_rotate=45,max_zoom=1.2,max_warp=0.05,max_lighting = 0.05,p_lighting=0.5,p_affine=0.5)#, xtra_tfms=extralist)
